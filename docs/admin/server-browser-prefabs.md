...
authoring model ([`world-generation.md`](../world/world-generation.md)); chunk lifecycle
([`world-chunks.md`](../world/world-chunks.md)); EOS/Steam auth handshakes
([`platform-auth.md`](../admin/platform-auth.md)).
...
[`platform-auth.md`](../admin/platform-auth.md)) rejects joiners until
...
- `CombinedPrimaryId` is set to the EOS ProductUserId and `CombinedNativeId`
  ...
  address both identity domains ([`platform-auth.md`](../admin/platform-auth.md)).
...
the web dashboard's API mirrors from prefs ([`webserver.md`](../admin/webserver.md)).
...
([`entity-ai.md`](../entities/entity-ai.md)): it delegates to
...
([`world-generation.md`](../world/world-generation.md)).
...
[`console-commands.md`](../admin/console-commands.md)).
...
([`game-events.md`](../content/game-events.md), [`protocol-packages.md`](../network/protocol-packages.md)).
...
| Doc | Role |
|---|---|
| [platform-auth.md](../admin/platform-auth.md) | EOS/Steam identity, AuthServer, login authorizers around `GameServerInitialized` |
| [server-lifecycle.md](../admin/server-lifecycle.md) | `StartAsServer` / `startGameCo` ordering that hosts this pipeline |
| [world-generation.md](../world/world-generation.md) | Writes `prefabs.xml`; authors the `PrefabVolumes` model consumed here |
| [world-chunks.md](../world/world-chunks.md) | Chunk lifecycle around `DecorateChunk` |
| [webserver.md](../admin/webserver.md) | HTTP admin surface that mirrors server prefs |
| this doc § EOS filters / [server-lifecycle.md](../admin/server-lifecycle.md) | `SessionsClient.matchesFilters` (client browse filter; not a dedicated sim path) |
| [game-events.md](../content/game-events.md) | `EventPrefabs` consumers of `PrefabInstance.Serializable` |
| [protocol-packages.md](../network/protocol-packages.md) | NetPackage inventory incl. the editor/world-init packages |
