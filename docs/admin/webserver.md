...
admin/web port), distinct from the game wire protocol ([`protocol.md`](../network/protocol.md)).
...
([console-commands.md](../admin/console-commands.md)). They run through the normal
...
| [protocol.md](../network/protocol.md) | The game wire protocol (separate from this HTTP surface) |
