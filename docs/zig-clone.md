...
**Stock ceilings:** [engine-limitations.md](engine-limitations.md) (why stock hits walls; measured on stock, not on zdtd).  
**Live scale walls:** [measured-scaling.md](measured-scaling.md) (stock APM ladders; design against these shapes).  
**Ranked bottlenecks + bang-for-buck:** [bottlenecks.md](bottlenecks.md) (what the clone must beat, and the structural theme: missing spatial index + serial stages).  
**Every hot algorithm:** [algorithms.md](algorithms.md).  
**Allocation strategy (why the clone uses arenas, no GC):** [allocation-reuse.md](allocation-reuse.md) - stock's Boehm STW measured **479 ms** on a ~7 GB heap (megapause); the clone must never STW.  
**Wire details:** [protocol.md](protocol.md).  
**Loop:** [loop.md](loop.md).  
**World/save:** [world-chunks.md](world-chunks.md), [save-region.md](save-region.md).  
**Entities:** [entity-ai.md](entity-ai.md).  
**Golden wire / join bots:** sibling [`../../7dtd-loadgen/`](../../7dtd-loadgen/) (`PackageCodec`, `JoinStateMachine`).  
**Implementation:** [`../../zdtd/`](../../zdtd/).
...
**Implementation tree:** sibling [`../../zdtd/`](../../zdtd/) (**zdtd** = Zig Days To Die).
...
Stock hot path reference: [loop.md](loop.md), [loop-gmupdate.md](loop-gmupdate.md).  
...
Detail: [measured-scaling.md](measured-scaling.md), [network.md](network.md) §4b.
...
2. **Linear send fan-out** - stock `ConnectionManager.SendPackage` linear-scans the
   ...
   applies to stock. See [bottlenecks.md](bottlenecks.md) §1-2.
...
Index: [terrain-height.md](terrain-height.md), [world-chunks.md](world-chunks.md), [save-region.md](save-region.md).
...
Stock AI LOD bands (distSq full / mid / far) are hints: [entity-ai.md](entity-ai.md).
...
- Do not commit game `Assembly-CSharp.dll` or bulk IL into a public clone repo; keep regenerable dumps under `research/il/` policy.
...
| Doc | Role |
|---|---|
| [protocol.md](protocol.md) | Wire framing, join, golden bodies |
| [engine-limitations.md](engine-limitations.md) | Stock ceilings |
| [loop.md](loop.md) | Sim orchestration |
| [network.md](network.md) | Replication + O(N²) mechanism |
| [entity-ai.md](entity-ai.md) | Authority AI path |
| [world-chunks.md](world-chunks.md) | Chunk pipeline |
| [save-region.md](save-region.md) | Disk layout |
| [measured-scaling.md](measured-scaling.md) | Stock APM ladders (design input only; not a zdtd tool) |
| [residuals.md](residuals.md) | Non-IL gaps |
...
| zdtd | [`../../zdtd/`](../../zdtd/) (implementation; no mods, no APM) |
