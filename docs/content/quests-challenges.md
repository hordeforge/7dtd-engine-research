...
sequences that deliver challenge rewards ([`game-events.md`](../content/game-events.md),
...
([`game-events.md`](../content/game-events.md)): an XML-parsed class object (`QuestClass` /
...
([`loop-gmupdate.md`](../loop/loop-gmupdate.md)), unconditionally (only a null guard, no
...
sequence, [`game-events.md`](../content/game-events.md)), and `QuestActionTrackQuest` /
...
([`server-lifecycle.md`](../admin/server-lifecycle.md) §4). `Cleanup()` runs on world
teardown / XML reload.
...
[`server-lifecycle.md`](../admin/server-lifecycle.md) §3), runs the shared-quest
...
`GameEventManager.HandleAction(...)` ([`game-events.md`](../content/game-events.md)): the
...
- **External / sibling (residuals):** challenge rewards are delivered by the
  `GameEvent.*` engine ([`game-events.md`](../content/game-events.md)); the journal and
  tracker widgets are XUi (client UI); the Twitch service backs the
  `*Twitch*` objectives. See [`residuals.md`](../meta/residuals.md).
...
- **`QuestJournal` leaves:** `AddQuestFactionPoint(id, difficultyTier)`
  ...
  `EntityTrader.GetQuestFactionPoints` reads, [npc-dialog.md](../content/npc-dialog.md)
  ...
  in [npc-dialog.md](../content/npc-dialog.md) §5).
...
Owned by [npc-dialog.md](../content/npc-dialog.md). Header:
...
Also `NetPackageQuestEntitySpawn` in [protocol-packages.md](../network/protocol-packages.md)
section 6.17.
...
| Doc | Role |
|---|---|
| [`game-events.md`](../content/game-events.md) | Sibling scripted-content engine; delivers challenge rewards and `QuestActionGameEvent` effects |
| [`server-lifecycle.md`](../admin/server-lifecycle.md) | `HandleAllPlayersDisconnect` on shutdown; `QuestJournal` persistence in player data |
| [`loop-gmupdate.md`](../loop/loop-gmupdate.md) | The manager chain that ticks `QuestEventManager.Update` |
| [`protocol.md`](../network/protocol.md) | `NetPackageQuestEvent` and related wire framing |
| [`managers.md`](../loop/managers.md) | Sibling in-process managers |
| [`full-surface.md`](../meta/full-surface.md) | Where the quest / challenge types sit in the whole-assembly map |
| [`re-methodology.md`](../meta/re-methodology.md) | How this was reversed |
| [`residuals.md`](../meta/residuals.md) | External / native residuals |
