...
([`buffs.md`](../gameplay/buffs.md)); the separate `GameEvent.*` scripted-sequence engine
([`game-events.md`](../content/game-events.md), contrasted in §8); client-only presentation
...
[`buffs.md`](../gameplay/buffs.md) and the stat system through `GetModifiedValueData`.
...
authoritative and remote entities do not re-apply. See [`buffs.md`](../gameplay/buffs.md) for
...
- **`IsAlly`** (IL=36): `target is EntityPlayer && IsFriendOfLocalPlayer()`
  ...
  `PersistentPlayerList` ally store; see [parties-factions.md](../social/parties-factions.md)).
...
Bridge into [game-events.md](../content/game-events.md).
...
MinEvent and [`GameEvent`](../content/game-events.md) are sibling data-driven effect
systems that solve different problems, and one action bridges them
(`MinEventActionCallGameEvent`).

| Axis | MinEvent (this doc) | GameEvent ([`game-events.md`](../content/game-events.md)) |
|---|---|---|
...
- **Server-authoritative and per-tick adjacent.** MinEvent dispatch runs wherever
  ...
  is the server entity update ([`entity-ai.md`](../entities/entity-ai.md),
  [`buffs.md`](../gameplay/buffs.md)). Buff, cvar, stat, progression, and damage actions
...
- **Content, not IL.** Which triggers fire which actions, with which
  ...
  effect catalog is data. See [`residuals.md`](../meta/residuals.md).
...
| Doc | Role |
|---|---|
| [`buffs.md`](../gameplay/buffs.md) | The `EntityBuffs` runtime that buff-source triggers and buff-modifier actions drive |
| [`game-events.md`](../content/game-events.md) | The sibling scripted-sequence engine (contrasted in §8) |
| [`entity-ai.md`](../entities/entity-ai.md) | The entity update that raises most combat / movement triggers |
| [`full-surface.md`](../meta/full-surface.md) | Where the `MinEvent*` types sit in the whole-assembly map |
| [`re-methodology.md`](../meta/re-methodology.md) | How this was reversed |
| [`residuals.md`](../meta/residuals.md) | Client-only and content residuals |
...
- **2026-08-11:** Action Execute IL re-verified (14): AddProgressionLevel IL=143, ModifyStat IL=117, GiveExp IL=63, GiveSkillExp IL=112, SetProgressionLevel IL=104, AwardChallenge/AwardQuestStat IL=41, SetItemInSlot IL=39, ResetHeldItem IL=13, SetHeldItemJammed IL=13, Rage IL=38, SetOverrideLoot IL=56, ShowToolbeltMessage IL=53, SetNavObject Execute IL=53 / ParseXmlAttribute IL=67, Entity.AddNavObject IL=24 / RemoveNavObject IL=15 (exact).
