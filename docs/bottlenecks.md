...
**Companion docs:** scaling laws [`measured-scaling.md`](measured-scaling.md); allocation
[`allocation-reuse.md`](allocation-reuse.md) + [`../../7dtd-optimizer/docs/ALLOCATION_UPSTREAM.md`](../../7dtd-optimizer/docs/ALLOCATION_UPSTREAM.md);
graded levers [`../../7dtd-optimizer/docs/OPTIMIZATION_CANDIDATES.md`](../../7dtd-optimizer/docs/OPTIMIZATION_CANDIDATES.md).
...
aggregate A/B in [`../../7dtd-optimizer/docs/RESULTS.md`](../../7dtd-optimizer/docs/RESULTS.md)
...
8. **`InitScan` node-buffer reuse (P4)** - kills the **#1 allocator**; concurrency
   ...
   cost. See [`ALLOCATION_UPSTREAM.md`](../../7dtd-optimizer/docs/ALLOCATION_UPSTREAM.md) Lever A.
