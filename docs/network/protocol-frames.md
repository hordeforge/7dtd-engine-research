...
**Companion:** narrative join/policy in [protocol.md](../network/protocol.md).  
...
Details: [network.md](../network/network.md) §2.
...
5. Link from [protocol.md](../network/protocol.md).
...
| Doc | Role |
|---|---|
| [protocol.md](../network/protocol.md) | Join SM, narrative |
| [network.md](../network/network.md) | Interest / scaling |
