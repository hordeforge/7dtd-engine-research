...
**Not:** the exhaustive per-package body catalog + protocol-wide metadata census (that is [`protocol-packages.md`](../network/protocol-packages.md)); LiteNet event dispatch internals (closed 2026-08-10, [network.md](../network/network.md) §4.0); EAC wire (residual).  
**Hub:** [INDEX.md](../INDEX.md).  
**Visual frames (RFC bars + Mermaid):** [`protocol-frames.md`](../network/protocol-frames.md).  
**Full package bodies + census (channels, compress, pre-auth, encryption handshake):** [`protocol-packages.md`](../network/protocol-packages.md).  
**Clone use:** [ZIG_CLONE.md](../../../zdtd-server/docs/ZIG_CLONE.md) · implementation [`../../zdtd-server/`](../../../zdtd-server).  
**Replication policy:** [network.md](../network/network.md).  
...
> **[protocol-frames.md](../network/protocol-frames.md)** (challenge, envelope, PackageIds, Login, PosAndRot, RelPos, AliveFlags, DamageEntity, …).
...
**Frame diagram:** [protocol-frames.md §1](../network/protocol-frames.md#1-challenge-raw-before-game-envelope).
...
**Frame diagram:** [protocol-frames.md §2](../network/protocol-frames.md#2-game-channel-envelope--package-stream).
...
8. `WorldStaticData.SendXmlsToClient` (config S2C; [mod-loading.md](../admin/mod-loading.md) section 5.6).
...
are in [platform-auth.md](../admin/platform-auth.md) section 3 (`playerAllowed`).
...
**Visual layouts (RFC + Mermaid):** [protocol-frames.md §7-§12](../network/protocol-frames.md#7-entityposandrot-body-buseq--30-bytes).
...
Stock selection thresholds (server outbound): [network.md](../network/network.md) §2.
...
Full layout: [protocol-packages.md](../network/protocol-packages.md) sections 6.14-6.15.
...
Replication path: [network.md](../network/network.md) §4b (per-player rebuild vs broadcast).
...
|---|---|---|
| compressed | 0 | Set per-package: **8 packages** force `get_Compress = 1` (bulk terrain/map/config), see [protocol-packages.md](../network/protocol-packages.md) §1.2 |
| encrypted | 0 | Public-key handshake decoded: [protocol-packages.md](../network/protocol-packages.md) §2 |
...
and per-package channel/compress/direction/auth: [`protocol-packages.md`](../network/protocol-packages.md) §1.
...
[`protocol-packages.md`](../network/protocol-packages.md) sections):

| Priority | Item | Why | Status |
|---:|---|---|---|
| P0 | NetPackageChunk body | Client terrain | **Done** ([protocol-packages.md](../network/protocol-packages.md) §3.1) |
...
| residual | LiteNet event dispatch | Closed 2026-08-10 ([network.md](../network/network.md) §4.0) | Closed |
...
| Doc | Role |
|---|---|
| **[protocol-frames.md](../network/protocol-frames.md)** | **Visual frame catalog (RFC + Mermaid)** |
| **[protocol-packages.md](../network/protocol-packages.md)** | **Per-package body catalog + metadata census + encryption handshake** |
| [re-methodology.md](../meta/re-methodology.md) | How the bodies were derived from IL |
| [ZIG_CLONE.md](../../../zdtd-server/docs/ZIG_CLONE.md) | Clone architecture |
| [network.md](../network/network.md) | Interest + scale |
| [closed-gaps.md](../entities/closed-gaps.md) | Package band thresholds |
| [engine-limitations.md](../meta/engine-limitations.md) | Net ceilings |
