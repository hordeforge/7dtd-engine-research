...
**Index math:** §2 below + [`terrain-height.md`](../world/terrain-height.md).  
**Save path:** [`save-region.md`](../world/save-region.md).  
...
([server-lifecycle.md](../admin/server-lifecycle.md) §3) and per stream-target.
...
before unload, see [dedicated-leftovers.md](../meta/dedicated-leftovers.md) §12); per
...
client value ([protocol.md](../network/protocol.md) section 5).
...
[loop.md](../loop/loop.md) entity tick; the cache itself is
...
4. **Map:** if `mapDatabase` set, append
   ...
   [protocol-packages.md](../network/protocol-packages.md) section 3.3).
...
([save-region.md](../world/save-region.md), [protocol-packages.md](../network/protocol-packages.md) section 3.1).
...
- `CalcOffset(x, y, z)` (IL=12) = `z*16 + x + (y & 3) * 256` - 1024 cells,
  ...
  ([`save-region.md`](../world/save-region.md) §2).
...
[`save-region.md`](../world/save-region.md) §2); `ChunkCluster.GetWater(pos)`
...
`cCollisionBlocks` = **5**, `cTraderPlacingProtection` = **2**,
`sleeper/trigger/wall` `*WorldStateSaveVersion` = **1** each
(`SleeperVolumeWorldStateSaveVersion`, `TriggerVolumeWorldStateSaveVersion`,
`WallVolumeWorldStateSaveVersion`).
...
| Doc | Role |
|---|---|
| [protocol-packages.md](../network/protocol-packages.md) | `NetPackageChunk` / `WorldInfo` wire |
| [protocol.md](../network/protocol.md) | join path that attaches chunk observers |
| [network.md](../network/network.md) | UpdateTick placement of SendChunks |
| [save-region.md](../world/save-region.md) | Chunk write/read; blob codec shared with NetPackageChunk |
| [terrain-height.md](../world/terrain-height.md) | YDim / height |
...
- **2026-08-11:** Chunk data IL re-verified: GetTileEntities IL=3, RemoveAllTileEntities IL=11, LoopOverAllBlocks IL=30 (Chunk) / IL=54 (Layer), LoopOverAllBlocksCoroutine IL=15 + MoveNext IL=69, RepairDensities IL=90, CheckDensities IL=129, ClearNeedsRegenerationAt IL=32, updateBounds IL=55, GetBlockWorldPosZ IL=7, GetSameDensityValue IL=16, OnLoad IL=97, OnUnload IL=188, removeExpiredCustomChunkDataEntries IL=61, ChunkBlockClearData.OnRemove IL=37, World.UnloadEntities IL=36, get_NeedsSaving IL=20 (exact).
- **2026-08-11:** Chunk flags IL re-verified: get_IsLocked IL=34, get_IsLockedExceptUnloading IL=30, get_IsInitialized IL=16, get/set_NeedsRegeneration IL=21/54, get/set_NeedsRegenerationAt IL=19/28, get_NeedsCopying IL=3, get_StopStabilityCalculation IL=3, get/set_ChunkPos IL=8/14, set_X/set_Z IL=9, get_Y IL=3, ExitWriteLock IL=4, IsEmptyLayer IL=22, GetSizeOfMesh IL=26 (exact).
- **2026-08-11:** Regen/load-state IL re-verified: DetermineChunksToLoad IL=448, ChunkManager.Init IL=104, ChunkPosNeedsRegeneration_DelayedStart IL=28 / DelayedStop IL=48, chunkRegenerateAt IL=49, UpdateRegenerationState IL=33, SecondsSinceChunkStarted/EndedRegeneration IL=20, NotifyOnChunksFinishedLoading IL=10, GetIndexedBlocks IL=71 (exact).
- **2026-08-11:** Texture/damage IL re-verified: GetDamage IL=8, SetDamage IL=9, Value64FullToIndex IL=12, TextureIdxToTextureFullValue64 IL=43, SetBlockFaceTexture IL=48 (Chunk) / IL=61 (Cluster), GetBlockFaceTexture IL=19 (Chunk) / IL=29 (PrefabChunk), GetTextureFullArray IL=22/17, worldToBlockPos IL=11 (exact).
- **2026-08-11:** Coordinate IL re-verified: ChunkCluster ToWorldPosition IL=5, ToLocalPosition IL=29, ToLocalVector IL=2, ToLocalKey IL=24, IsOnBorder IL=32, Chunk.ToWorldPos IL=14/20/16, ToLocalPosition(Vector3i) IL=23, IsInChunk IL=30, World toChunkXYZ IL=14, toChunkXYZCube IL=17, toChunkXyzWorldPos IL=17, TryRetrieveAndRemovePendingDowngradeBlock IL=14 (World), generateTerrain IL=11 (exact).
- **2026-08-11:** Observer IL re-verified: IsForceUpdate IL=8, ForceUpdate IL=4, RemoveChunkObserver IL=29, GroundAlignFrameUpdate IL=42, ResendChunksToClients IL=55, IsPositionAvailable IL=43, OnLoadedFromCache IL=90, AdJustEntityTracking IL=50 (exact).
