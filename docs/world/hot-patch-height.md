...
- [terrain-height.md](../world/terrain-height.md) - stock vs expanded constants, measured
- [mod-loading.md](../admin/mod-loading.md) - `IModApi.InitMod` runs pre-world
- [chunk-providers.md](../world/chunk-providers.md) - chunk construction/lifetime
