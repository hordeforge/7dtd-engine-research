...
see [loop-gmupdate.md](../loop/loop-gmupdate.md)).
...
fraction behind `Entity.CalcWaterLevel` ([entity-ai.md](../entities/entity-ai.md)).
...
[protocol-packages.md](../network/protocol-packages.md) section 6.9.
...
Apply-stage prose also in [dedicated-misc-systems.md](../meta/dedicated-misc-systems.md) (`WaterSimulationApplyChanges`, `WaterUtils`, `ChunkHandle`). Leaves for the job structs are in [../inventories/dedicated-leaves.md](../inventories/dedicated-leaves.md) (light-mesh-water group).
...
| [terrain-height.md](../world/terrain-height.md) | YDim context |
| [dedicated-misc-systems.md](../meta/dedicated-misc-systems.md) | ApplyChanges / ChunkHandle short form |
| [loop-gmupdate.md](../loop/loop-gmupdate.md) | gmUpdate call order |
