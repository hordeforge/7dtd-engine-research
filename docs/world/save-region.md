...
(join path in [protocol.md](../network/protocol.md) section 5).
...
**Expand note:** changing only `WorldConstants.ChunkBlockLayers` does **not** change this loop; patcher must rewrite the `ldc.i4.s 64` sites. Detail: `7dtd-realearth/docs/realearth-surfaces.md` §5.0.
...
modules, see [`tile-entities-power.md`](../gameplay/tile-entities-power.md)).
...
belongs to the zdtd clone, not stock; see [stability.md](../world/stability.md).)
...
([dynamic-mesh.md](../world/dynamic-mesh.md) §1).
...
| [world-chunks.md](../world/world-chunks.md) | Load/unload pipeline |
| [terrain-height.md](../world/terrain-height.md) | YDim pin vs byte heightmaps |
| [loop.md](../loop/loop.md) | When SaveWorldState is invoked |
| [light-mesh-water.md](../world/light-mesh-water.md) | Water sim also schedules via WorldBlockTicker |
