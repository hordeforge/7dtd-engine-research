...
[texture-atlas-unityfs.md](../world/texture-atlas-unityfs.md) stops: that page decodes
...
**Owns:** the Shader (class 48) sub-program blob: LZ4 per-platform blobs, 12-byte record table, code-blob record, and the 38-byte DX11 program-data header before the DXBC.  
