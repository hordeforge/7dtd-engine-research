...
**Chunk index / save-64:** [`world-chunks.md`](../world/world-chunks.md), [`save-region.md`](../world/save-region.md).  
...
| [`../il/terrain-v3.2.0/`](../../il/terrain-v3.2.0) | Dedicated, expanded snapshot | **Historical** expanded YDim (RealEarth); live dedi is stock again, see [`coverage.md`](../meta/coverage.md) live pin |
...
are narrated in [`chunk-providers.md`](../world/chunk-providers.md) §4.1.
...
| Doc | Role |
|---|---|
| [`loop.md`](../loop/loop.md) | Dedicated frame/sim loop (entities, managers) |
...
| [engine-limitations.md](../meta/engine-limitations.md) | Generic dedi ceilings (height + others) |
...
Non-IL residuals only: [`residuals.md`](../meta/residuals.md). Product soak/ops items are **not** unmapped engine RE.
...
| Light/sun/mesh sites loading **255** | **CLOSED** inventory, [`light-mesh-water.md`](../world/light-mesh-water.md), `realearth-surfaces.md` §7.1 |
| RegionFileRaw type map + header constants | **CLOSED**, [`save-region.md`](../world/save-region.md) |
...
| Optional sector payload hand-annotation | [`residuals.md`](../meta/residuals.md) |
...
| Doc | Why |
|---|---|
| [save-region.md](../world/save-region.md) | Chunk write/read, WorldState |
| [world-chunks.md](../world/world-chunks.md) | Gen trampoline, dirty lifecycle |
