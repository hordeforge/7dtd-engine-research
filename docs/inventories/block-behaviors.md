...
**Framework:** [`../world/blocks.md`](../world/blocks.md) owns the contract; this describes each `Block` leaf.  
**Regenerate:** hint extractor over transitive subclasses.
**Hub:** [`INDEX.md`](../INDEX.md).  

Every transitive `Block` subclass (block behavior leaf: doors, plants, powered, traps, loot, hazards, ...). Contract: [blocks.md](../world/blocks.md).
