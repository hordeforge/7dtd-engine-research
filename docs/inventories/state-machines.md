...
**74 state machines** across **42 docs**.
...
| 2. Damage application (state machine) | [combat-damage.md](../combat-damage.md) | 10 |
| 3. Death and kill (state machine) | [combat-damage.md](../combat-damage.md) | 9 |
| 2. When AI actually runs (`OnUpdateLive` → `updateTasks`) | [entity-ai.md](../entity-ai.md) | 7 |
...
| 3.4 Source on/off state | [tile-entities-power.md](../tile-entities-power.md) | 5 |
| 4. Workstation and forge crafting | [tile-entities-power.md](../tile-entities-power.md) | 6 |
...
| 3. Player join and persistence (state machine) | [server-lifecycle.md](../server-lifecycle.md) | 9 |
...
| 5. Mutation / dirty | [world-chunks.md](../world-chunks.md) | 5 |
