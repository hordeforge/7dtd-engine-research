...
**Not:** host CCD/NUMA ops ([HOST_TUNING](../../7dtd-optimizer/docs/HOST_TUNING.md)), product RealEarth status.  
**Loop/net context:** [`loop.md`](loop.md), [`network.md`](network.md).  
**Ceiling map (static):** [`engine-limitations.md`](engine-limitations.md).  
**Hub:** [`INDEX.md`](INDEX.md).

Empirical complement to the static IL map ([`loop.md`](loop.md), [`network.md`](network.md)).  
...
| Doc | Why |
|---|---|
| [`loop.md`](loop.md) | Static frame/tick map; `AstarManager.UpdateGraphs` peer (§12) |
| [`network.md`](network.md) | Player-axis send path (`updatePlayerList`, `PooledBinaryWriter`) |
| [`entity-ai.md`](entity-ai.md) | Entity-axis tick / AI onion behind the linear cost |
| [`runtime-tuning.md`](runtime-tuning.md) | GC is downstream of the allocation ranked in §4b |
## Related docs

| Doc | Role |
|---|---|
| [loop.md](loop.md) | Static IL map |
| [network.md](network.md) | Net packages |
