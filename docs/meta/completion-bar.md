...
**Hub:** [`INDEX.md`](../INDEX.md). **Coverage tool:** [`coverage.md`](../meta/coverage.md),
...
| **B. Dedi-critical behaviour closed** | Families 1-11 in [coverage.md](../meta/coverage.md): loop, wire, entities, world, save, net, managers, light/mesh/water, ModEvents | Status **Closed** + residual only non-IL |
...
| **D. Non-IL residuals** | EAC wire, A* library, content XML, client UI (Unity order + LiteNet event dispatch closed 2026-08-09/10) | Listed in [residuals.md](../meta/residuals.md); **cannot** be closed by more managed RE |
...
4. If client/telemetry/third-party: add to [out-of-scope-surface.md](../meta/out-of-scope-surface.md).
...
| Tier A+B | this doc | **Met** for V3.2.0 b10 managed dedi bar |
...
| ChatMessageServer / GameMessage | [chat.md](../social/chat.md) |
...
| Astar UpdateGraphs merge size 76 | [loop.md](../loop/loop.md) |
...
| Stability queueStabilityAvail cap 200 | [stability.md](../world/stability.md) |
| getMaxStabilityAround + ChangeStability | [stability.md](../world/stability.md) |
...
| Interest enter package order (Speeds/Velocity) | [network.md](../network/network.md) §2.1 |
...
| SpawnEntityInWorld registration + BuffValue.Tick | [spawning.md](../gameplay/spawning.md) / [buffs.md](../gameplay/buffs.md) |
| NetEntityDistribution SEnts distances + Remove | [network.md](../network/network.md) |
...
| PlayerDisconnected path + MemoryPools.Cleanup + reason 2 | [server-lifecycle.md](../admin/server-lifecycle.md) §3.2 |
...
| GetRandomSpawnPositionMinMaxToPosition IL=240 ring/disc sampler | [spawning.md](../gameplay/spawning.md) §6.1 |
| GetSpawnWalkType IL=9 + GameUtils.GetViewDistance IL=10 | entity-ai.md D8.6 / server-lifecycle |
| SetupEntityCreationData ECD builder + CreateEntity wrapper | [spawning.md](../gameplay/spawning.md) §7 |
...
| PlayerSpawnedInWorld IL=127 full body (Died SetAlive, JoinedGame msg, waypoints) | [server-lifecycle.md](../admin/server-lifecycle.md) §3 |
...
| SendChunksToClients IL=216 body (cap 3/tick, reverse reloads, map pkgs) | [world-chunks.md](../world/world-chunks.md) §4.0a |
...
| EntityClass.Init IL=1465 config source + tier calc + flags parse | entity-ai.md D8.6b |
| ItemClass.GetItem resolver + Constants pins (see distance 48, port 26900) | entity-ai.md D8.6 / CHANGELOG |
...
| LiteNet event dispatch (managed) | Closed 2026-08-10 ([network.md](../network/network.md) §4.0); EAC wire | Native / anti-cheat black box |
...
These stay in [residuals.md](../meta/residuals.md). Closing them is product/ops/runtime
...
| Doc | Role |
|---|---|
| [coverage.md](../meta/coverage.md) | The census tiers this bar defines |
| [residuals.md](../meta/residuals.md) | What stays open regardless of narration |
