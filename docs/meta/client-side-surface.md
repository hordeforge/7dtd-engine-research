...
**Owns:** the stock game's client-side subsystems - reachable from the dedicated
...
[out-of-scope-surface.md](../meta/out-of-scope-surface.md); this doc narrates each type's role
...
| `RequestDetails` | Object | remove_Callback, add_Callback, ExecuteCallback; V3.2.0 b10: +`Transfer`, +`Cancelled` ([platform-auth.md](../admin/platform-auth.md) §6, [changelog-3.2.0.md](../releases/changelog-3.2.0.md) §8) |
...
| `SDCSArchetypesFromXml` | Object | parseArchetype, Save, parseEquipment, narrated in [sdcs-character-gear.md](../content/sdcs-character-gear.md) §3.2 |
| `SDCSDataUtils` | Object | Load, Save, ParseRaceVariantFromResources, narrated in [sdcs-character-gear.md](../content/sdcs-character-gear.md) §3.3 |
| `SDCSUtils` | Object | setupEquipment, Stitch, setupHairObjects, narrated in [sdcs-character-gear.md](../content/sdcs-character-gear.md) §§4-8 |
...
- [out-of-scope-surface.md](../meta/out-of-scope-surface.md) - the authoritative client/3rd-party classification.
- [coverage.md](../meta/coverage.md) - the census and how these tiers are counted.
