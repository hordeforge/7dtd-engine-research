...
(`FindCallers`, since retired for `Xref`; see [re-methodology.md](../meta/re-methodology.md) §8b)
...
gamestage. Complements [spawning.md](../gameplay/spawning.md) (sleeper volumes) and the
...
[light-mesh-water.md](../world/light-mesh-water.md) §4 (job graph, flow rules, net
...
[console-commands.md](../admin/console-commands.md) (command permission levels) and
[webserver.md](../admin/webserver.md) (web session permissions).
...
[console-commands.md](../admin/console-commands.md) permission gate) round-trips its
...
[console-commands.md](../admin/console-commands.md) and [webserver.md](../admin/webserver.md).
...
are client-only paths. Complements [mod-loading.md](../admin/mod-loading.md) (XML
patching) and [platform-auth.md](../admin/platform-auth.md).
...
[spawning.md](../gameplay/spawning.md) and [entity-stats.md](../entities/entity-stats.md).
...
[world-chunks.md](../world/world-chunks.md).
...
[combat-damage.md](../gameplay/combat-damage.md) and [raycast-pathing.md](../entities/raycast-pathing.md).
...
[server-lifecycle.md](../admin/server-lifecycle.md) and
[save-persistence.md](../world/save-persistence.md).
...
Complements [save-persistence.md](../world/save-persistence.md) and
...
[server-lifecycle.md](../admin/server-lifecycle.md) and
[sandbox-options.md](../admin/sandbox-options.md).
...
- **`GamePrefs.HasStockSettings()` (IL=162, exact):** true iff every declared
  ...
  from the preset, [sandbox-options.md](../admin/sandbox-options.md) 8).
...
[aidirector.md](../entities/aidirector.md) (air drops) and
[game-events.md](../content/game-events.md).
...
chunks or exceed one cell. Complements [blocks.md](../world/blocks.md) and
[block-shapes.md](../world/block-shapes.md).
...
(decoration clearance). Complements [blocks.md](../world/blocks.md) and
[raycast-pathing.md](../entities/raycast-pathing.md).
...
for drone behavior. Complements [entity-ai.md](../entities/entity-ai.md).
...
`NetPackageBlockLimitTracking`. Complements [blocks.md](../world/blocks.md).
...
[combat-damage.md](../gameplay/combat-damage.md).
...
([world-generation.md](../world/world-generation.md)), prefab vertex counts do influence
...
[re-methodology.md](../meta/re-methodology.md) on the limits of caller-based
...
- **DismemberedPart**: detached-limb visual (prefab spawn, fade, transform
  ...
  `EntityAlive` ([combat-damage.md](../gameplay/combat-damage.md)).
- **RaidEvent, BitsUsedEvent**: Twitch EventSub payload DTOs consumed only by
  ...
  ([twitch-integration.md](../social/twitch-integration.md); the server side is just the
...
- **BaseItemActionEntry** and **ItemActionEntryRepair/Scrap/Craft/Use/Assemble**:
  ...
  ([crafting-recipes.md](../gameplay/crafting-recipes.md), [items.md](../gameplay/items.md)).
...
documented with their consumers in [`block-shapes.md`](../world/block-shapes.md) §5.
...
carries (wire census: [`protocol-packages.md`](../network/protocol-packages.md)). The
...
[`dedicated-leftovers.md`](../meta/dedicated-leftovers.md)), `poolBinaryReader` /
...
([`protocol-packages.md`](../network/protocol-packages.md), [`save-region.md`](../world/save-region.md), this file). Two layers:
...
- **`IMapChunkDatabase/DirectoryPlayerId`** (fields `file`, `dir`): the
  ...
  producer side is [protocol-packages.md](../network/protocol-packages.md) §3.3.
...
([loop.md](../loop/loop.md)); `GameManager` calls `TaskManager.Init` at startup and
...
live in [mod-loading.md](../admin/mod-loading.md) / [loop.md](../loop/loop.md) (field
inventory in [managers.md](../loop/managers.md)); the interrupt semantics of the
interruptible pair are in [chat.md](../social/chat.md) §3.
...
| Doc | Role |
|---|---|
| [dedicated-leftovers.md](../meta/dedicated-leftovers.md) | Sibling grab-bag of small dedicated systems |
| [out-of-scope-surface.md](../meta/out-of-scope-surface.md) | The client/out-of-scope classification boundary |
...
- **2026-08-11:** GameRandom IL re-verified: InternalSample IL=61, Sample IL=6, PeekSample IL=50, GetSampleForLargeRange IL=22, SetSeed IL=4 / InternalSetSeed IL=118, NextBytes IL=26, Next(min,max) IL=37, CreateGameRandom IL=5/8 (exact).
- **2026-08-11:** DynamicProperties IL re-verified: Parse IL=123, Add IL=5, AddArray IL=70, Load IL=37, ValidateKey IL=21, ReplaceProperty IL=15, GetValue IL=10, TryGetValue IL=8/18, GetString IL=9, GetBool/GetInt/GetFloat IL=13, ParseBool IL=26, ParseString IL=9, GetParam1 IL=10, GetClass IL=10, GetLocalizedString IL=9, ParseLocalizedString IL=12, ParseData IL=82, ParseKeyData IL=29, ParseStringFloatDictWithSubStringKey IL=47, CopyFrom IL=78, copyDict IL=27, copyKey IL=43, GetNestedExclusions IL=42 (exact).
- **2026-08-11:** XML/bedroll IL re-verified: ParseSubtitleNode IL=104, MaterialsFromXml.CreateMaterials IL=6, WeatherSurvivalParametersFromXml.Load IL=121, EntityBedrollPositionList GetData IL=7 / GetPos IL=13 / Set IL=11 / Clear IL=8 / get_Count IL=9 / get_Item IL=3 (exact).
- **2026-08-11:** Startup IL re-verified (GameStartupHelper): ParseCommandLine IL=82, LoadConfigFile IL=146, ParsePref IL=74, ParseGamePref IL=24, GamePrefs.Parse IL=45, ApplyParsedGamePrefs IL=57, ValidateGameName IL=41 / ValidateGameNameInput IL=46, InitGamePrefs IL=36, SetDedicatedServerSettings IL=51; GameRandom.Next(max) IL=14 (exact).
- **2026-08-11:** MultiBlock IL re-verified (17): TryRegisterPOIMultiBlock IL=132, TryRegisterCrossChunkMultiBlock IL=179, TryRegisterOversizedBlock IL=82, TryRegisterTerrainAlignedBlock IL=5 / Internal IL=154, DeregisterTrackedBlockDataInternal IL=36, ProcessDeregistrationCleanup IL=84, CullCompletePOIPlacements IL=69, CullChunklessData IL=65 / OnClient IL=69, SetOversizedStabilityDirty IL=100, SetTerrainAlignmentDirty IL=46 / dispatcher IL=14, OnChunkInitialized IL=51, OnChunkRegeneratedOrDisplayed IL=34, TryGetOversizedBlock IL=115, GetMinMaxWorldPositions IL=44 (exact).
- **2026-08-26 (vehicle storage pin):** the minibike's basket is the vehicle
  ENTITY's inventory: `EntityVehicle.InitInventory` (IL=6) sets
  `EntityAlive.inventory = new VehicleInventory(...)`; the basket contents
  are NOT carried by `EntityVehicle.Write` (IL=18), `WriteSyncData` (IL=239),
  the ECD `write` (IL=358), or a dedicated vehicle-inventory package - the
  only inventory packages in the assembly are the player's own
  (NetPackagePlayerInventory: toolbelt/bag/equipment) and the
  InventoryManager TransactionalInventory pair (trading/vending windows,
  keyed by GUID). The basket S2C sync path for multiplayer observers is NOT
  pinned from the dump set; a targeted dump of the entity-inventory
