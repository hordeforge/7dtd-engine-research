# Whole-assembly surface map and coverage ledger (V3.2.0)
...
1,743,842 IL instructions**, across 88 namespaces (regenerate with
...
`il/full-v3.2.0/` after a full run is the 100% reversal: one `<Type>.il.txt` per
...
| **Pathfinding** | `GamePath`, `RaycastPathing` | **Narrated** ([entity-ai.md](../entities/entity-ai.md) §6 ASP wrapper, [closed-gaps.md](../entities/closed-gaps.md) ASP->A*); Aron Granberg A* search internals **closed 2026-08-12** (raycast-pathing.md §5.1) |
| **Utility AI** | `UAI` | **Narrated** ([uai.md](../entities/uai.md)): packages, considerations, tasks, decision/selection cycle |
| **World generation** | `WorldGenerationEngineFinal`, `PrefabVolumes`, `SDF` | **Narrated** ([world-generation.md](../world/world-generation.md)); `MapRendering`/clipping tools client-render residual |
| **Content: events / quests / challenges** | `GameEvent.*`, `Quests`, `Challenges` | **Narrated** ([game-events.md](../content/game-events.md), [quests-challenges.md](../content/quests-challenges.md)) |
| **Audio / music** | `Audio`, `DynamicMusic*` (5 ns), `MusicUtils*`, `mumblelib`, `TriggerEffects` | Out of dedicated scope (client-only) |
| **Twitch integration** | `Twitch*` (3 ns) | **Narrated** ([twitch-integration.md](../social/twitch-integration.md)) for the server action/vote slice; connection client-hosted residual |
| **Web admin API** | `Webserver*` (14 ns) | **Narrated** ([webserver.md](../admin/webserver.md)): pipeline, auth/session, permissions, REST host, SSE |
| **Data / XML pipeline** | `XMLData.*` (6 ns), `XMLEditing` | Not narrated (content parse; XML semantics are content, not loop IL) |
| **Platform / auth / transport** | `Platform.*` (14 ns incl EOS/Steam/XBL/PSN/LAN) | **Narrated** ([platform-auth.md](../admin/platform-auth.md)) for the server auth path; native SDK crypto/anticheat residual |
...
| **Bundled third-party libraries** | `UniLinq`, `ICSharpCode.WpfDesign.XamlDom`, `ConcurrentCollections`, `Microsoft.CodeAnalysis`, `SandboxOptions`, `System.*` | Vendored libs; `UniLinq` (LINQ impl) and `ConcurrentCollections.ConcurrentHashSet` are **live helpers** called by server code (RWG/Twitch/chunk queues, [dedicated-leftovers.md](../meta/dedicated-leftovers.md)); the rest are unreferenced or non-game |
...
project's stated bar, [`coverage.md`](../meta/coverage.md)), which is the dedicated sim
core + wire protocol, a small but load-bearing slice of the 7,451 types.

| Subsystem | Narrative | Depth |
|---|---|---|
| Frame / sim loop | [loop.md](../loop/loop.md), [loop-gmupdate.md](../loop/loop-gmupdate.md) | Deep (gmUpdate 631 IL fully mapped) |
| Entities / AI / path | [entity-ai.md](../entities/entity-ai.md), [aidirector.md](../entities/aidirector.md), [closed-gaps.md](../entities/closed-gaps.md) | Deep (tick chain, thresholds, EAI) |
| World / chunks | [world-chunks.md](../world/world-chunks.md) | Deep |
| Terrain / height | [terrain-height.md](../world/terrain-height.md) | Deep |
| Save / region | [save-region.md](../world/save-region.md) | Deep (SaveLoad 926 IL) |
| Light / mesh / water | [light-mesh-water.md](../world/light-mesh-water.md) | Deep |
| Managers / ModEvents | [managers.md](../loop/managers.md) | Method-level |
| Networking / wire | [network.md](../network/network.md), [protocol.md](../network/protocol.md), [protocol-frames.md](../network/protocol-frames.md), [protocol-packages.md](../network/protocol-packages.md) | Deep (195 packages, framing, encryption) |
| Web admin server | [webserver.md](../admin/webserver.md) | Deep (HTTP pipeline, auth/session, permissions, REST, SSE) |
| Console / telnet admin | [console-commands.md](../admin/console-commands.md) | Deep (registry, dispatch, permission gate, telnet auth) |
| Server lifecycle / persistence | [server-lifecycle.md](../admin/server-lifecycle.md) | Deep (boot, game state + **game modes** §2.1, player data, land claims, shutdown) |
| Buffs / effects | [buffs.md](../gameplay/buffs.md) | Deep (tick lifecycle, duration/stack, net sync) |
| Game events / scripted content | [game-events.md](../content/game-events.md) | Deep (sequence/action/requirement/decision/loop state machines) |
| Platform auth / join | [platform-auth.md](../admin/platform-auth.md) | Deep (identity, server auth flow, EAC/EOS managed boundary) |
| Entity spawning | [spawning.md](../gameplay/spawning.md) | Deep (5 spawn sources, caps/attrition, observer-gated client spawn) |
| Tile entities + power | [tile-entities-power.md](../gameplay/tile-entities-power.md) | Deep (TE storage/tick, power graph 6.25Hz, crafting, traps) |
| Chat / system messages | [chat.md](../social/chat.md) | Deep (wire, channel routing, system messages) |
| Vehicles / drones / turrets | [vehicles-drones-turrets.md](../gameplay/vehicles-drones-turrets.md) | Deep (registries, motion authority, drone/turret state machines) |
| World generation (RWG) | [world-generation.md](../world/world-generation.md) | Deep (WorldBuilder stage pipeline, threading, outputs) |
| Weather / environment | [weather-environment.md](../gameplay/weather-environment.md) | Deep (server sim, storm machine, temperature survival) |
| Crafting / recipes | [crafting-recipes.md](../gameplay/crafting-recipes.md) | Deep (recipe model, validation, queue, unlock) |
| MinEvent triggered effects | [minevents.md](../content/minevents.md) | Deep (FireEvent dispatch, 111 triggers, action/target/requirement model) |
| Loot / traders / economy | [loot-economy.md](../gameplay/loot-economy.md) | Deep (loot gen/respawn, trader restock/hours/pricing, vending) |
| Quests / challenges | [quests-challenges.md](../content/quests-challenges.md) | Deep (template/instance, objective + reward lifecycles) |
| Progression / skills | [progression.md](../gameplay/progression.md) | Deep (XP/level-up, perk purchase, calculated level) |
| Blocks framework | [blocks.md](../world/blocks.md) | Deep (BlockValue bitfield, virtual surface, damage/upgrade, change flow) |
| Entity / survival stats | [entity-stats.md](../entities/entity-stats.md) | Deep (health/food/water/stamina over-time, starvation) |
| Stealth / noise / smell | [stealth-smell.md](../entities/stealth-smell.md) | Deep (server light/noise/smell detection inputs) |
| Items framework | [items.md](../gameplay/items.md) | Deep (ItemValue packing, ItemAction contract, use/durability, inventory) |
| Combat / damage | [combat-damage.md](../gameplay/combat-damage.md) | Deep (DamageSource, apply pipeline, death/kill) |
| Twitch integration | [twitch-integration.md](../social/twitch-integration.md) | Server slice (action/vote execution via game events); connection client residual |
| Mod loading / ModEvents | [mod-loading.md](../admin/mod-loading.md) | Deep (load pipeline, EAC gate, hook lifecycle) |

| Dynamic mesh | [dynamic-mesh.md](../world/dynamic-mesh.md) | Deep (server regen threading, persistence, channel-1 flow control) |
| Parties / factions / allies | [parties-factions.md](../social/parties-factions.md) | Deep (party lifecycle, faction standing matrix, ally handshake) |
...
Individual leaf **blocks** (e.g. `BlockMine`, `BlockLiquidSource`, `BlockSpawnEntity`) and **tile-entity features** (`TEFeatureLandClaim`, ...) are instances of the documented `Block.UpdateTick` surface ([blocks.md](../world/blocks.md)) and the tile-entity feature framework ([tile-entities-power.md](../gameplay/tile-entities-power.md)); the frameworks own them, so they are covered without a doc each.
...
and listed in [residuals.md](../meta/residuals.md). LiteNetLib is a managed assembly;
its event machinery and the join-churn flake root cause are closed in
[network.md](../network/network.md) §4.0.
...
| Doc | Role |
|---|---|
| [coverage.md](../meta/coverage.md) | Dedicated-relevant managed family checklist |
| [residuals.md](../meta/residuals.md) | What managed IL cannot close |
| [re-methodology.md](../meta/re-methodology.md) | How to reverse any of the above |
