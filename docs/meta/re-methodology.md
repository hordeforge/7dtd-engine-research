...
`V3.2.0 b9`), a path to an assembly outside the install dir (a steamcmd scratch
download), or, for a raw Steam build id (`24911252`), through that build's
...
held-entity feature ([items.md](../gameplay/items.md) § Held entities) and join analytics
([server-lifecycle.md](../admin/server-lifecycle.md) `PlayerJoinServerEventData`) in the V3.2.0
...
[`residuals.md`](../meta/residuals.md), not faked from IL:
...
[`shader-subprogram-blob.md`](../world/shader-subprogram-blob.md):
...
| [`protocol.md`](../network/protocol.md) | Wire framing + annotated package bodies |
| [`protocol-frames.md`](../network/protocol-frames.md) | Visual byte frames |
| [`coverage.md`](../meta/coverage.md) | Family -> narrative -> dump map |
| [`residuals.md`](../meta/residuals.md) | What IL cannot close |
| [`shader-subprogram-blob.md`](../world/shader-subprogram-blob.md) | Shader (class 48) compiled-code container |
| [`texture-atlas-unityfs.md`](../world/texture-atlas-unityfs.md) | UnityFS container + SerializedFile tables |
