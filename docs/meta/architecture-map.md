...
attack surface ([`protocol-packages.md`](../network/protocol-packages.md)).
...
Full per-doc index with audit status: [`coverage.md`](../meta/coverage.md). Leaf catalogs and
...
[`out-of-scope-surface.md`](../meta/out-of-scope-surface.md), and the reachability caveats
...
| [coverage.md](../meta/coverage.md) | Per-doc audit status and family map |
| [loop.md](../loop/loop.md) | The frame in depth |
| [protocol.md](../network/protocol.md) | Wire framing and join in depth |
| [full-surface.md](../meta/full-surface.md) | Whole-assembly namespace map |
| [out-of-scope-surface.md](../meta/out-of-scope-surface.md) | What the server does not run |
