...
| `tools/xml_pins.py` | Machine-checked XML data pins (entityclasses HP ladder, traders.xml economy) from `Data/Config`; regenerated by `stock-sync`, asserted by `check_stock_facts` |
