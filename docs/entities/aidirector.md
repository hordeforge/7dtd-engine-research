...
**Tick path:** [`entity-ai.md`](../entities/entity-ai.md), [`loop.md`](../loop/loop.md) §5.  
**Install order detail:** [`closed-gaps.md`](../entities/closed-gaps.md).  
...
Scout / activity-driven hordes (see also [spawning.md](../gameplay/spawning.md)).
...
(true = under cap; same formula as [spawning.md](../gameplay/spawning.md)).
...
director/spawn paths; see [spawning.md](../gameplay/spawning.md)).
...
This blob rides `WorldState` nested `aiDirectorState` ([save-region.md](../world/save-region.md)).
...
GamePref 82; [server-lifecycle.md](../admin/server-lifecycle.md)).
...
`InitNewGame` and `Read` ([weather-environment.md](../gameplay/weather-environment.md)
boundary derivation).
...
day-7 party budget (enemy max 2, vs the wandering horde's 5). No BM zombies
spawned before the bot drowned; the start event itself is what needed
pinning.
...
if day changed store `bmDay` and log freq/range. **Operational note
...
applies over a 0 pref, [sandbox-options.md](../admin/sandbox-options.md) 7).
...
| Doc | Role |
|---|---|
| [entity-ai.md](../entities/entity-ai.md) | AI throttle |
| [closed-gaps.md](../entities/closed-gaps.md) | Default components |
| [spawning.md](../gameplay/spawning.md) | Scout/screamer horde lifecycle |
