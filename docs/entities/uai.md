...
([`entity-ai.md`](../entities/entity-ai.md)); helper internals it calls
...
`EntityAlive.updateTasks` ([`entity-ai.md`](../entities/entity-ai.md) §3.3): entities whose
...
players, every ~10th tick at 0.1 far away, [`entity-ai.md`](../entities/entity-ai.md) §4).
...
the same 8-per-slice path drain as EAI ([`entity-ai.md`](../entities/entity-ai.md) §D3.7).
...
- **The subsystem is live code but dormant content in stock V3.0.1.** The
  ...
  [`entity-ai.md`](../entities/entity-ai.md) §6.5).
...
| Doc | Role |
|---|---|
| [entity-ai.md](../entities/entity-ai.md) | The `updateTasks` gate that calls `UAIBase.Update`, EAI counterpart, pathfinding |
| [loop.md](../loop/loop.md) | Frame / tick context above the entity chain |
| [full-surface.md](../meta/full-surface.md) | Where `UAI.*` sits in the whole-assembly map |
