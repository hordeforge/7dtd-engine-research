...
**Loop context:** [`loop.md`](../loop/loop.md), [`loop-gmupdate.md`](../loop/loop-gmupdate.md).  
**Ceiling map:** [`engine-limitations.md`](../meta/engine-limitations.md) §4 (AI volume, path ≤8, dual paths).  
...
- Movement/combat: `GetStaminaMultiplier` (IL=2) is 1 (base);
  ...
  gravity, collision) is [entity-movement.md](../entities/entity-movement.md);
...
([closed-gaps.md](../entities/closed-gaps.md) path narrative).
...
- Optional prioritization (`enableNetworkdPrioritization`): airborne enemies get
  ...
  with a **16384** (128^2) view-cone gate; see [network.md](../network/network.md) section 2.1
...
| [closed-gaps.md](../entities/closed-gaps.md) | Timer, path ASP, net bands |
| [aidirector.md](../entities/aidirector.md) | Component inventory |
...
Full cycle narrative: [spawning.md](../gameplay/spawning.md) §2 (IL=441). Re-pin numbers:
...
Scout path uses ticks **2000** / **6000** (see [aidirector.md](../entities/aidirector.md)).
...
Related S2C packages (wakeup / pose / passive): [protocol-packages.md](../network/protocol-packages.md)
...
- **`InitPostCommon()` (IL=97):** dedicated → `ServerHelper.SetupForServer`
  ...
  `utilityAIContext = new UAI.Context(this)` (see [uai.md](../entities/uai.md)). Adds any
...
bandit-only (plus `EAIPathTest`), so like UAI ([`uai.md`](../entities/uai.md) §9) it is
...
Also on the wire (see [protocol-packages.md](../network/protocol-packages.md) section 6.21):
...
[items.md](../gameplay/items.md) (held-entity item types).
