...
**Owns:** the walker move chain and physics surface: `MoveHelper` -> `Entity::Move` -> CharacterController collision, gravity, friction.  
...
attached (see [`entity-ai.md`](../entities/entity-ai.md) D8.6c for the init chain):
...
See [`terrain-height.md`](../world/terrain-height.md#height-api-inventory-harmony-targets).
