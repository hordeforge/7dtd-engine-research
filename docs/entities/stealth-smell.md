...
**Not:** the AI decision that consumes them ([entity-ai.md](../entities/entity-ai.md) CanSee /
...
[`light-mesh-water.md`](../world/light-mesh-water.md)).
...
- **Consumer:** zombie/sleeper sensing in [entity-ai.md](../entities/entity-ai.md) reads the
...
| Doc | Role |
|---|---|
| [entity-ai.md](../entities/entity-ai.md) | AI sensing/CanSee that consumes stealth; sleeper wake |
| [items.md](../gameplay/items.md) | Carried items that generate smell |
| [buffs.md](../gameplay/buffs.md) | Buffs/perks that modify stealth (from progression) |
| [weather-environment.md](../gameplay/weather-environment.md) | Wetness that affects smell |
| [spawning.md](../gameplay/spawning.md) | Sleeper volumes woken by detection |

## Changelog

- **2026-08-11:** Stealth tail IL re-verified: Entity.GetBrightness IL=53, SmellTickEat IL=36 (exact).
