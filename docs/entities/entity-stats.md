# Entity and survival stats (dedicated V3.2.0)
...
[weather-environment.md](../gameplay/weather-environment.md)); the individual stat XML content;
the HUD (client).
...
([server-lifecycle.md](../admin/server-lifecycle.md)) and net-sync to the owning client.
...
[weather-environment.md](../gameplay/weather-environment.md)). Food and water deplete with
...
- **Food / water** (`UpdatePlayer{Food,Water}OT`): deplete on a timer plus activity;
  consumables (via [items.md](../gameplay/items.md) / [buffs.md](../gameplay/buffs.md)) restore them.
...
[weather-environment.md](../gameplay/weather-environment.md); several felt-temperature helper
...
Wire bodies: [protocol-packages.md](../network/protocol-packages.md) section 6.16. Server
...
| Doc | Role |
|---|---|
| [weather-environment.md](../gameplay/weather-environment.md) | Temperature / weather-survival cvar to buff path |
| [buffs.md](../gameplay/buffs.md) | Buffs that modify stats and apply survival effects |
| [items.md](../gameplay/items.md) | Consumables that restore food/water/health |
| [entity-ai.md](../entities/entity-ai.md) | The entity update that ticks stats |
| [server-lifecycle.md](../admin/server-lifecycle.md) | Stats persisted with the profile; death/respawn |
