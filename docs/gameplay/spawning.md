...
(those are [`entity-ai.md`](../entities/entity-ai.md)); the blood-moon and wandering-horde
director components themselves ([`aidirector.md`](../entities/aidirector.md)); the
`NetPackageEntitySpawn` wire layout ([`protocol-packages.md`](../network/protocol-packages.md) §5.1);
...
([sandbox-options.md](../admin/sandbox-options.md)) map into.
...
lifecycle is owned by [`aidirector.md`](../entities/aidirector.md). This subsystem owns only
...
[protocol.md](../network/protocol.md) post-spawn), trader respawn
([loot-economy.md](../gameplay/loot-economy.md)) and scout placement
([aidirector.md](../entities/aidirector.md)). Signature
...
`World.SpawnEntityInWorld`). See [protocol-packages.md](../network/protocol-packages.md)
section 5.0.
...
(Guid) carried at the end of the spawn body ([protocol-packages.md](../network/protocol-packages.md)
...
3. `grabDisabled()` (IL=25, V3.2.0 new): true while any pending request has
   ...
   coop items, `ItemClassHeldEntity` family, [items.md](../gameplay/items.md) § Held
...
[`entity-ai.md`](../entities/entity-ai.md) §9) walks players against tracked entities by
distance and view angle and emits `NetPackageEntitySpawn` (an
`EntityCreationData` payload, [`protocol-packages.md`](../network/protocol-packages.md) §5.1)
...
([`entity-ai.md`](../entities/entity-ai.md) §10, D8); this doc's role is to note that the
...
[`chunk-providers.md`](../world/chunk-providers.md) §4.1.
...
- **Residual (persisted state):** per-chunk `ChunkAreaBiomeSpawnData` and
  ...
  ([`save-region.md`](../world/save-region.md)); their contents are runtime data.
...
- **`SupplyCrateSpawn`** (nested `AIAirDrop/SupplyCrateSpawn`, base `Object`,
  ...
  air-drop director component ([`aidirector.md`](../entities/aidirector.md)).
- **`EntitySupplyCrate.OnUpdateEntity` (IL=103):** base `EntityAlive` tick plus
  ...
  markers, [map-objects.md](../gameplay/map-objects.md)). `wasOnGround = onGround`.
...
- **`RequestToSpawnPlayer` join path (IL=496):** server creates the remote
  ...
  wire bodies: [protocol.md](../network/protocol.md) section 5. `PlayerSpawnedInWorld` is a
...
- **`SPlayerSpawningData`** (nested `ModEvents/SPlayerSpawningData`, a
  ...
  This is an in-process mod-hook data struct ([`managers.md`](../loop/managers.md)
...
| Doc | Role |
|---|---|
| [entity-ai.md](../entities/entity-ai.md) | What a spawned entity does next: tick, AI, path, and `NetEntityDistribution` replication |
| [aidirector.md](../entities/aidirector.md) | Blood-moon and wandering-horde director components (separate from this doc's spawners) |
| [protocol-packages.md](../network/protocol-packages.md) | `NetPackageEntitySpawn` / `EntityCreationData` wire layout (§5.1) |
| [loop.md](../loop/loop.md) | `OnUpdateTick` frame context that drives the biome loop |
| [world-chunks.md](../world/world-chunks.md) | Chunk-area grid and chunk custom data |
| [network.md](../network/network.md) | Entity replication cost |
| [managers.md](../loop/managers.md) | Other in-process managers |
| [save-region.md](../world/save-region.md) | Where per-chunk spawn budgets persist |
| [full-surface.md](../meta/full-surface.md) | Where this sits in the whole-assembly map |
| [re-methodology.md](../meta/re-methodology.md) | How this was reversed |
| [residuals.md](../meta/residuals.md) | Content and native residuals |
