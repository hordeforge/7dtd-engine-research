...
math applied by perks ([buffs.md](../gameplay/buffs.md)).
...
bought level (shared with the passive-effect system, [buffs.md](../gameplay/buffs.md)).
`Read`/`Write` persist progression with the player profile
([server-lifecycle.md](../admin/server-lifecycle.md)) and send a network variant to the
owning client.
...
`ActionAddXP` / `ActionAddPlayerLevel` ([minevents.md](../content/minevents.md)).
...
([crafting-recipes.md](../gameplay/crafting-recipes.md) §3), modify stats and item behavior
through passive effects ([buffs.md](../gameplay/buffs.md)), and gate abilities. The server
...
- `RemoveSpawnPoints(showTooltip)` (IL=19) clears
  ...
  `selectedSpawnPointKey = -1` (bedroll removal, [spawning.md](../gameplay/spawning.md) §4).
...
Used by party/horde spawner sizing ([aidirector.md](../entities/aidirector.md)
...
| Doc | Role |
|---|---|
| [minevents.md](../content/minevents.md) | `ActionAddXP` / `ActionAddPlayerLevel` XP sources |
| [crafting-recipes.md](../gameplay/crafting-recipes.md) | Perks unlock recipes |
| [buffs.md](../gameplay/buffs.md) | Perk passive-effect math + calculated level |
| [aidirector.md](../entities/aidirector.md) | Party level from member `gameStage` |
| [server-lifecycle.md](../admin/server-lifecycle.md) | Progression persisted with the player profile |
