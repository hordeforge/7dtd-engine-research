...
**Not:** the wire package body layout ([protocol-packages.md](../network/protocol-packages.md)
section 6.11 / [protocol.md](../network/protocol.md) section 6.5, `NetPackageDamageEntity`
write IL=144 (V3.2.0; V3.1.0 was 176)); item attack authoring ([items.md](../gameplay/items.md)); block
damage ([blocks.md](../world/blocks.md)); the ragdoll/hit VFX (client).
...
Suffocation, see [protocol.md](../network/protocol.md) §6.5), direction, the attacker entity
...
([items.md](../gameplay/items.md)), powered traps and turrets
([tile-entities-power.md](../gameplay/tile-entities-power.md),
[vehicles-drones-turrets.md](../gameplay/vehicles-drones-turrets.md)), explosions, environment
(fall, suffocation, temperature), and MinEvent damage actions
([minevents.md](../content/minevents.md)).
...
[progression.md](../gameplay/progression.md)), clears death buffs
([buffs.md](../gameplay/buffs.md) `RemoveDeathBuffs`), drops loot
([loot-economy.md](../gameplay/loot-economy.md)), and for players enters the respawn path
([server-lifecycle.md](../admin/server-lifecycle.md)).
...
`get_gameStage` "days lived" input ([progression.md](../gameplay/progression.md)).
...
each damage event ([protocol.md](../network/protocol.md) §6.5).
...
([protocol.md](../network/protocol.md) §6.5) and funnel into the same `DamageEntity` path, so
...
- **`StunBeamWeapon`** (nested in `DroneWeapons`, subclass of
  ...
  [buffs.md](../gameplay/buffs.md)), then spawns muzzle flash/smoke particles and audio
...
| Doc | Role |
|---|---|
| [items.md](../gameplay/items.md) | Attack item actions that build a DamageSource |
| [entity-stats.md](../entities/entity-stats.md) | Health the damage is applied to |
| [buffs.md](../gameplay/buffs.md) | On-hit / death buffs, damage modifiers |
| [progression.md](../gameplay/progression.md) | Kill XP award |
| [protocol.md](../network/protocol.md) | `NetPackageDamageEntity` wire body (§6.5) |
| [blocks.md](../world/blocks.md) | Block damage (separate but parallel) |

## Changelog

- **2026-09-11:** IL citations refreshed against the V3.2.0 b10 assembly: `ItemActionAttack.Hit` 1614 -> 1564 (exact). Prior values were the V3.1.0 b14 measurement.
...
- **2026-08-08:** ItemActionAttack.Hit IL=1564 orchestration: attacker
