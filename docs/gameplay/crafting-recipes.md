...
[tile-entities-power.md](../gameplay/tile-entities-power.md)); the crafting UI (client); XML
recipe content.
...
`TransactionalInventory` (the anti-dupe gate, [items.md](../gameplay/items.md)), and (2)
**workstation** crafting, whose queue ticks inside the server-owned
`TileEntityWorkstation` ([tile-entities-power.md](../gameplay/tile-entities-power.md)). So the
...
tier (shared with the passive-effect/buff math, [buffs.md](../gameplay/buffs.md)).
...
`Constants.cMaxLoadTimePerFrameMillis` (**50 ms**), so a large `recipes.xml` streams in
...
[tile-entities-power.md](../gameplay/tile-entities-power.md)); backpack crafting runs it on the
player.
...
backpack UI sync packages ([protocol.md](../network/protocol.md)).
...
progression, saved with the player profile ([server-lifecycle.md](../admin/server-lifecycle.md)).
...
| Doc | Role |
|---|---|
| [tile-entities-power.md](../gameplay/tile-entities-power.md) | Workstation/forge that hosts a craft queue |
| [items.md](../gameplay/items.md) | ItemValue/ItemClass (ingredients + output) |
| [buffs.md](../gameplay/buffs.md) | Passive-effect math (crafting-tier quality) |
| [server-lifecycle.md](../admin/server-lifecycle.md) | Player progression / unlock persistence |

## Changelog

- **2026-08-11:** cMaxLoadTimePerFrameMillis pinned 50 ms (Constants cctor IL).
