...
([`quests-challenges.md`](../content/quests-challenges.md)); the gmUpdate scheduling of
`NavObjectManager.Update` ([`managers.md`](../loop/managers.md)); map chunk/fog-of-war
sync (`NetPackageMapChunks`, [`protocol-packages.md`](../network/protocol-packages.md));
UI widget layout.
...
[`managers.md`](../loop/managers.md), 42 IL): it prunes entries whose `IsValid()` went
...
| Quest markers (quest, treasure, fetch, cache, sleepers) | client-derived | `Quest.HandleMapObject` / `ObjectiveClearSleepers` on the quest owner's client; see [`quests-challenges.md`](../content/quests-challenges.md) |
...
- [managers.md](../loop/managers.md): `NavObjectManager.Update` in the gmUpdate chain.
- [quests-challenges.md](../content/quests-challenges.md): quest state driving `Quest.HandleMapObject`.
- [protocol-packages.md](../network/protocol-packages.md): NetPackage wire formats.
- [aidirector.md](../entities/aidirector.md): air-drop component that pushes crate markers.
- [dynamic-mesh.md](../world/dynamic-mesh.md): `DynamicMeshConsoleCmd` debug waypoint.
