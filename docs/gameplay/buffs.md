...
per-tick dedicated codepath ([entity-ai.md](../entities/entity-ai.md) calls into it via the
entity update).
...
- **Residual / content:** `buffs.xml` effect definitions (data); the `MinEvent`
  ...
  [minevents.md](../content/minevents.md); `EntityStats` math.
...
see [protocol-packages.md](../network/protocol-packages.md) section 6.16 and
[entity-stats.md](../entities/entity-stats.md) section 5.

## Related docs

| Doc | Role |
|---|---|
| [entity-ai.md](../entities/entity-ai.md) | The entity update that ticks buffs |
| [minevents.md](../content/minevents.md) | The MinEvent trigger/action framework that applies buffs |
| [server-lifecycle.md](../admin/server-lifecycle.md) | Player persistence (buffs saved with the profile) |
| [protocol-packages.md](../network/protocol-packages.md) | Buff add/remove packages on the wire |
...
- `SetCustomVarNetwork(name, value, operation)` (IL=33) is the wire half of the
  ...
  ([protocol-packages.md](../network/protocol-packages.md) `NetPackageModifyCVar`).
