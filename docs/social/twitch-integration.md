...
([game-events.md](../content/game-events.md)) and the systems it drives (spawning, buffs,
items, weather).
...
states, which is the [managers.md](../loop/managers.md) "waste if constructed without Twitch"
note.
...
| Doc | Role |
|---|---|
| [game-events.md](../content/game-events.md) | The interpreter that executes Twitch actions |
| [spawning.md](../gameplay/spawning.md) | Spawn effects triggered by Twitch actions |
| [buffs.md](../gameplay/buffs.md) | Buff effects triggered by Twitch actions |
