# Chat and system messages (dedicated V3.2.0)
...
console command execution ([console-commands.md](../admin/console-commands.md)).
...
`write` order (IL=63, little-endian; see [protocol-packages.md](../network/protocol-packages.md) section 6.17 for
conventions):
...
([console-commands.md](../admin/console-commands.md)); the Discord relay is external.
...
`PlayerSpawnedInWorld` / disconnect, see [server-lifecycle.md](../admin/server-lifecycle.md))
...
| Doc | Role |
|---|---|
| [console-commands.md](../admin/console-commands.md) | Command messages (chat starting with the command prefix) |
| [protocol-packages.md](../network/protocol-packages.md) | Wire package conventions |
| [managers.md](../loop/managers.md) | `ModEvents` (the `ChatMessage` hook) |
| [server-lifecycle.md](../admin/server-lifecycle.md) | Join/leave system messages |
