...
`AIDirectorGameStagePartySpawner`, see [`spawning.md`](../gameplay/spawning.md) / [`aidirector.md`](../entities/aidirector.md));
the shared-quest mechanics themselves ([`quests-challenges.md`](../content/quests-challenges.md));
...
`PersistentPlayerList` ([`server-lifecycle.md`](../admin/server-lifecycle.md) §3).
...
- **Group gamestage / loot.** `get_GameStage` runs the member gamestages through
  ...
  and loot difficulty scale to the group ([`spawning.md`](../gameplay/spawning.md), [`loot-economy.md`](../gameplay/loot-economy.md)).
- **Shared quests.** `PartyQuests.ShareAllQuestsWithParty` and the leave / kick /
  ...
  in `QuestEventManager` ([`quests-challenges.md`](../content/quests-challenges.md) §5). Party
...
- `MinEventActionTargetedBase.isValidTarget` filters buff / effect targets by
  ...
  to decide friend versus enemy ([`buffs.md`](../gameplay/buffs.md), [`minevents.md`](../content/minevents.md)).
...
([`server-lifecycle.md`](../admin/server-lifecycle.md) §3). `WriteXml` / `ReadXml` emit an
...
- **Naming collisions (residual).** `AIDirectorBloodMoonParty` and
  ...
  `Party` ([`spawning.md`](../gameplay/spawning.md) / [`aidirector.md`](../entities/aidirector.md)); this doc
...
- **External / content (residuals).** `PlatformUserIdentifierAbs` and `PartyVoice` voice
  lobbies are platform-service backed ([`platform-auth.md`](../admin/platform-auth.md)); the
...
| Doc | Role |
|---|---|
| [`server-lifecycle.md`](../admin/server-lifecycle.md) | `PersistentPlayerList` (`AllyStore.Allies`, land claims) and player persistence |
| [`quests-challenges.md`](../content/quests-challenges.md) | Shared-quest scope that parties drive (`QuestEventManager`, `PartyQuests`) |
| [`chat.md`](../social/chat.md) | `EChatType.Party` channel routing for party chat |
| [`spawning.md`](../gameplay/spawning.md) | Party gamestage / loot stage feeding horde and loot difficulty; AI "party" spawners |
| [`uai.md`](../entities/uai.md) | `UAIConsiderationTargetFactionStanding` faction-weighted AI targeting |
| [`buffs.md`](../gameplay/buffs.md) | `MinEventActionTargetedBase` relationship-tier target filtering |
| [`protocol-packages.md`](../network/protocol-packages.md) | Wire package conventions and direction bands |
| [`full-surface.md`](../meta/full-surface.md) | Where these types sit in the whole-assembly map |
| [`re-methodology.md`](../meta/re-methodology.md) | How this was reversed |
| [`residuals.md`](../meta/residuals.md) | External / native / content residuals |
