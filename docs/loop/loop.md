# Dedicated server game / sim loop (V3.2.0)

**Owns:** dedicated frame/sim loop narrative (peers, phases, subsystem scale).  
**Coverage map:** [`coverage.md`](../meta/coverage.md).  
...
**Ceiling map:** [`engine-limitations.md`](../meta/engine-limitations.md).  
**Zig clone redesign:** [`ZIG_CLONE.md`](../../../zdtd-server/docs/ZIG_CLONE.md).
...
Detailed phase narrative: [`loop-gmupdate.md`](../loop/loop-gmupdate.md).
...
Slice model (EMA frame gaps, ~25 base, `tickEntitySliceCount`): [`entity-ai.md`](../entities/entity-ai.md).
...
Deep detail: [`entity-ai.md`](../entities/entity-ai.md), path/net gaps: [`closed-gaps.md`](../entities/closed-gaps.md).
...
Canonical list (only place that owns permanent opens): [`residuals.md`](../meta/residuals.md).  
...
| Entity GO enabled on dedi | **closed** (2026-08-10 runtime: spawned entities keep GO active + MB enabled, 17/17 observed; registries populate on `SpawnEntityInWorld`, empty only on idle world; see [residuals.md](../meta/residuals.md)) |
...
| Doc | Role |
|---|---|
| [loop-gmupdate.md](../loop/loop-gmupdate.md) | gmUpdate phase narrative |
| [entity-ai.md](../entities/entity-ai.md) | TickEntity / AI |
| [network.md](../network/network.md) | ConnectionManager / packages |
