# `gmUpdate` structure (V3.2.0 dedicated RE)

**Owns:** gmUpdate phase narrative (detail under [`loop.md`](../loop/loop.md) §2).  
...
Entity → AI → path → fall → net interest deep dive: [`entity-ai.md`](../entities/entity-ai.md).

## Changelog

- **2026-08-11:** gmUpdate IL re-verified: gmUpdate IL=631, UpdateTick IL=150, updatePauseState IL=94, Pause(bool) IL=5, IsPaused IL=3, SetToolTipPause IL=10, ThreadManager.UpdateMainThreadTasks IL=64 (exact).
