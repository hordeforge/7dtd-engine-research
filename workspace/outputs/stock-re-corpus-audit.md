...
**What was audited as the “codebase”:** `tools/src/*` dumpers and pin gates; consumers `../zdtd` and `../7dtd-loadgen`; live local dedicated `Assembly-CSharp.dll` (not redistributed).
...
| zdtd version | [`../zdtd/src/version.zig`](../../../zdtd/src/version.zig) |
| zdtd protocol constants | [`../zdtd/src/protocol.zig`](../../../zdtd/src/protocol.zig) |
