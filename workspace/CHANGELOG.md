...
path to `../zdtd-server/docs/RE_GAP_CLOSURE.md` §2 so the clone matches. Verification
...
## 2026-08-12 - tier-C: provenance-review prompt moved to zdtd. docs/provenance-review-prompt.md removed from research; the reusable prompt now lives at ../../zdtd-server-server/docs/PROVENANCE_REVIEW_PROMPT.md (with the zdtd hub). Research INDEX row repointed; coverage audit row dropped. All gates green; pushed.
