...
def main():
    ...
    lines.append("//! `../7dtd-research/tools/sandbox/atlas/ta_*.xml` by")
    lines.append("//! `../7dtd-research/tools/sandbox/gen_atlas_zig.py` (do not hand-edit).")
    ...
    lines.append("//! in the 7dtd-research repo). Colors are packed with the stock")
