...
| `tests/test_tuned_constants.py` | 507 tuned game constants across ~56 families (AI-director horde/placement/cooldown, water-sim, block masks + BlockValue layouts, entity/walk-type ids, spawn rings, stealth/smell, vehicle/drone/turret, region/chunk/world, RWG, threat levels) pinned against the DLL and stated in the owning docs; completeness scan fails on any un-allowlisted const-rich class. |
