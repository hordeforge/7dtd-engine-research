...
class DumpDediComplete {
  ...
  static void Main(string[] a) {
    ...
    File.WriteAllText(Path.Combine(outDir,"INDEX.md"), "# dedi-complete dump\n\nAuto: DEDI_COMPLETE_auto.md\nNarrative: 7dtd-engine-research/docs/meta/coverage.md\n");
    File.WriteAllText(Path.Combine(outDir,"README.md"), "# dedi-complete\n\nRegenerable. DumpDediComplete.cs\nName the output dir for the release it was dumped from.\n");
